#!/usr/bin/env python
####CURRENTLY binary  is hard coded

'''
working to use a script to integrate  w/muse
(og: The binary contains an easter egg and a stack buffer overflow.)
'''
...
def main():
    ...
    #do i need if already going to file
    ...
    '''
    #PHASE 2--targets a specific address
